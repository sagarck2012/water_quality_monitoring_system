...
class Temperature extends StatefulWidget {
  ...
  const Temperature({Key? key, required this.value, required this.timestamp,required this.token}) : super(key: key);
                        ...
                        child:Column(
                          ...
                          children: [
                            Center(
                              ...
                              Text(
                                '${dataList.isNotEmpty ? dataList[3]?.value : 0.0} °C',
                                  ...
                                  Row(
                                    ...
                                    children:  [
                                      ...
                                      Text(
                                        ...
                                        // '${dataList[1]?.value}',
                                        '${dataList.isNotEmpty ? dataList[2]?.value : 0.0} °C',
                                        // "asknal",
                                        style:  GoogleFonts.notoSans(
                                          fontSize:  16,
                                          fontWeight:  FontWeight.w500,
                                  ...
                                  Row(
                                    ...
                                    children:  [
                                      ...
                                      FittedBox(
                                        child: Text(
                                          // Vm2 (11:26479)
                                          '${dataList.isNotEmpty ? dataList[1]?.value : 0.0} °C',
                                          // '7.00',
                                          style:  GoogleFonts.notoSans (
                                            fontSize:  16,
                                            fontWeight:  FontWeight.w500,
                                ...
                                Container(
                                  ...
                                  Row(
                                    ...
                                    children:  [
                                      ...
                                      Text(
                                        // qM2 (11:26481)
                                        '${dataList.isNotEmpty ? dataList[0]?.value : 0.0} °C',
                                        // '6.50',
                                        style:  GoogleFonts.notoSans(
